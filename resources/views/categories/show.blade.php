            ...
            @foreach($category->shirts as $shirt)
                ...
                <div class="card border-primary mb-3" style="max-width: 500px;">
                    <div class="row ceg-0">
                        ...
                        <div class="col-md-6">
                            <h4 class="card-body ">{{$shirt->shirt_name}}
                            </h4>

                            <a href="/shirt/{{$shirt->slug}}" class="btn btn-outline-primary btn-block">Shirt Detail</a>
                            <a href="/shirt/{{$shirt->slug}}/edit" class="btn btn-outline-warning btn-block">Shirt Edit</a>
